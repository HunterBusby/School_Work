...
//Last modified: Mon, Oct 23, 2023 02:18:14 PM
//Codeset: 1252
...
fileInfo "UUID" "A9D71D13-469A-2B9C-5D6A-B1BB2841566B";
createNode transform -s -n "persp";
	rename -uid "FD7817F3-469F-B491-C613-92A5F9FD683F";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 23.947496907480474 25.36636838069187 53.23266749448311 ;
	setAttr ".r" -type "double3" -15.041132377381862 3263.5542347389614 4.3370464427786118e-16 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 59.351519588245175;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "D1FD99C7-4890-487A-9110-2AB7459107D0";
	setAttr -s 17 ".lnk";
	setAttr -s 17 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "BC6D71BF-4B40-E74D-F583-DDBEE4505F04";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 1 0 ;
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "E5B3A97D-4EC7-C319-0251-70821B745ECA";
createNode displayLayerManager -n "layerManager";
	rename -uid "C8DDCFDA-454D-9FA6-114A-D4AF1E73CEC5";
createNode displayLayer -n "defaultLayer";
	rename -uid "2D41B0FD-439A-68BB-AED7-E9AEA5D7F9EF";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "91A5D7FD-4383-AC3A-3A1D-AA98A82087C5";
...
createNode animCurveTA -n "PALbot_cog_ctrl_rotateZ";
	...
	setAttr -s 10 ".ktv[0:9]"  0 0 4 7.5454158175126125 8 0 16 -6.7578983962135091
		 20 0 24 -9.0098244828737855 28 0 36 6.9644941815068 40 0 41 0;
...
createNode animCurveTA -n "PALbot_L_ShoulderRotate_ctrl_rotateZ1";
	...
	setAttr -s 7 ".ktv[0:6]"  0 41.738041649649411 4 53.460099787914572
		 8 24.224729587958244 12 3.4143313395453392 24 -83.279 40 41.738 41 0;
	setAttr -s 7 ".kit[4:6]"  18 18 18;
	setAttr -s 7 ".kot[4:6]"  28 28 18;
...
connectAttr "PALbot_L_IK_Foot_ctrl_translateZ.o" "PALBotRN.phl[43]";
connectAttr "PALbot_L_IK_Foot_ctrl_translateY.o" "PALBotRN.phl[44]";
...
connectAttr "PALbot_chestUp_ctrl_translateZ.o" "PALBotRN.phl[79]";
connectAttr "PALbot_chestUp_ctrl_translateX.o" "PALBotRN.phl[80]";
connectAttr "PALbot_chestUp_ctrl_translateY.o" "PALBotRN.phl[81]";
...
connectAttr "PALbot_R_FK_Wrist_ctrl_rotateY.o" "PALBotRN.phl[120]";
connectAttr "PALbot_R_FK_Wrist_ctrl_rotateX.o" "PALBotRN.phl[121]";
...
connectAttr "PALbot_L_FK_Wrist_ctrl_rotateY.o" "PALBotRN.phl[146]";
connectAttr "PALbot_L_FK_Wrist_ctrl_rotateX.o" "PALBotRN.phl[147]";
...
connectAttr "PALbot_R_IK_Foot_ctrl_translateZ.o" "PALBotRN.phl[339]";
connectAttr "PALbot_R_IK_Foot_ctrl_translateY.o" "PALBotRN.phl[340]";
connectAttr "PALbot_R_IK_Foot_ctrl_translateX.o" "PALBotRN.phl[341]";
