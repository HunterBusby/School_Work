...
//Last modified: Thu, Oct 19, 2023 12:28:31 PM
//Codeset: 1252
...
fileInfo "UUID" "93BB89FF-46CF-6A25-81AD-C18C99B9BFFD";
...
createNode animCurveTL -n "PALbot_cog_ctrl_translateY";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  0 -0.58390107807885627 4 -1.3246494729133165
