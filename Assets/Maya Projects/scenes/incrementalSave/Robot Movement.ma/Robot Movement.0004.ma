...
//Last modified: Tue, Oct 17, 2023 05:00:01 PM
//Codeset: 1252
...
fileInfo "UUID" "BBCBC536-4B32-2B94-0982-9C93BF0A3195";
createNode transform -s -n "persp";
	rename -uid "FD7817F3-469F-B491-C613-92A5F9FD683F";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1.2796245672739526 6.2397904504036505 27.957821126526866 ;
	setAttr ".r" -type "double3" 8.3588676118273764 1.954234749089049 -7.4587631682197442e-17 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 28.616777742325521;
...
createNode animCurveTA -n "PALbot_cog_ctrl_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 0 4 -8.5383876573964592 8 0 12 0;
...
createNode animCurveTL -n "PALbot_L_IK_Foot_ctrl_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 -4.4461965779190543e-16 4 -2.0367573455483967e-16
...
createNode animCurveTL -n "PALbot_L_IK_Foot_ctrl_translateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 3.6305950262677178 4 1.6631385857264893
...
createNode animCurveTL -n "PALbot_R_knee_aim_ctrl_translateX";
	...
	setAttr -s 4 ".ktv[0:3]"  0 0.2665502806083242 4 0.41890727980580394
		 8 0.68553202840139349 12 0.85421299179860322;
createNode animCurveTL -n "PALbot_R_knee_aim_ctrl_translateY";
	...
	setAttr -s 4 ".ktv[0:3]"  0 -7.9152069376422658e-16 4 -1.2437172267158606e-15
		 8 -1.8897122737896236e-15 12 -2.535707320863387e-15;
createNode animCurveTL -n "PALbot_R_knee_aim_ctrl_translateZ";
	...
	setAttr -s 4 ".ktv[0:3]"  0 2.1417643136943464e-15 4 1.6862056762890652e-15
		 8 1.0354076228529494e-15 12 3.8460956941683298e-16;
...
createNode animCurveTA -n "PALbot_chestUp_ctrl_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  0 7.1301591273580662;
...
connectAttr "PALbot_L_ShoulderRotate_ctrl_translateX.o" "PALBotRN.phl[35]";
connectAttr "PALbot_L_ShoulderRotate_ctrl_translateY.o" "PALBotRN.phl[36]";
connectAttr "PALbot_L_ShoulderRotate_ctrl_translateZ.o" "PALBotRN.phl[37]";
connectAttr "PALbot_R_knee_aim_ctrl_space_switch.o" "PALBotRN.phl[38]";
connectAttr "PALbot_R_knee_aim_ctrl_translateX.o" "PALBotRN.phl[39]";
connectAttr "PALbot_R_knee_aim_ctrl_translateY.o" "PALBotRN.phl[40]";
connectAttr "PALbot_R_knee_aim_ctrl_translateZ.o" "PALBotRN.phl[41]";
connectAttr "PALbot_R_knee_aim_ctrl_rotateX.o" "PALBotRN.phl[42]";
connectAttr "PALbot_R_knee_aim_ctrl_rotateY.o" "PALBotRN.phl[43]";
connectAttr "PALbot_R_knee_aim_ctrl_rotateZ.o" "PALBotRN.phl[44]";
connectAttr "PALbot_R_IK_Foot_ctrl_Heel_Peel.o" "PALBotRN.phl[45]";
connectAttr "PALbot_R_IK_Foot_ctrl_follow_hip.o" "PALBotRN.phl[46]";
connectAttr "PALbot_R_IK_Foot_ctrl_translateZ.o" "PALBotRN.phl[47]";
connectAttr "PALbot_R_IK_Foot_ctrl_translateY.o" "PALBotRN.phl[48]";
connectAttr "PALbot_R_IK_Foot_ctrl_translateX.o" "PALBotRN.phl[49]";
connectAttr "PALbot_R_IK_Foot_ctrl_rotateX.o" "PALBotRN.phl[50]";
connectAttr "PALbot_R_IK_Foot_ctrl_rotateY.o" "PALBotRN.phl[51]";
connectAttr "PALbot_R_IK_Foot_ctrl_rotateZ.o" "PALBotRN.phl[52]";
connectAttr "PALbot_R_IK_footBall_ctrl_translateX.o" "PALBotRN.phl[53]";
connectAttr "PALbot_R_IK_footBall_ctrl_translateY.o" "PALBotRN.phl[54]";
connectAttr "PALbot_R_IK_footBall_ctrl_translateZ.o" "PALBotRN.phl[55]";
connectAttr "PALbot_R_IK_footBall_ctrl_rotateX.o" "PALBotRN.phl[56]";
connectAttr "PALbot_R_IK_footBall_ctrl_rotateY.o" "PALBotRN.phl[57]";
connectAttr "PALbot_R_IK_footBall_ctrl_rotateZ.o" "PALBotRN.phl[58]";
