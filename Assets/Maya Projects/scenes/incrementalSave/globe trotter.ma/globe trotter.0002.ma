...
//Last modified: Fri, Oct 13, 2023 08:28:05 PM
//Codeset: 1252
...
fileInfo "UUID" "AE485993-4899-B844-9B8F-E0A97AD36604";
createNode transform -s -n "persp";
	rename -uid "04C1C0C8-454E-A89A-BBF1-1D8D024FA5CE";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -13.427637680185679 4.067919468345182 41.249093431401157 ;
	setAttr ".r" -type "double3" -5.8326044211205961 1428.2985402281231 2.0300355989845208e-16 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 40.166333406464275;
...
createNode transform -n "lineartaper2_0" -p "|hunte__dev__Tree_subnet__1_01|tube_object1";
	...
	setAttr ".t" -type "double3" -4.0365325916528967 -1.4438003301620483 -2.241227995616569 ;
	setAttr ".r" -type "double3" -18.904782095347567 4.3781035580011283 12.56604316569466 ;
createNode mesh -n "lineartaper2_0Shape" -p "|hunte__dev__Tree_subnet__1_01|tube_object1|lineartaper2_0";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
createNode houdiniAsset -n "hunte__dev__Tree_subnet__1_02";
...
createNode transform -n "lineartaper2_0" -p "|hunte__dev__Tree_subnet__1_02|tube_object1";
	rename -uid "3A1F294B-4CF4-6CEA-8672-76A7A12C11D3";
	setAttr ".t" -type "double3" -3.9645981788635254 -0.53233909606933594 -2.7500910758972168 ;
	setAttr ".r" -type "double3" 0 -76.639517630947338 0 ;
createNode mesh -n "lineartaper2_0Shape" -p "|hunte__dev__Tree_subnet__1_02|tube_object1|lineartaper2_0";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
createNode houdiniAsset -n "hunte__dev__Tree_subnet__1_03";
	...
	addAttr -is true -ci true -sn "houdiniAssetParm_bend2" -ln "houdiniAssetParm_bend2" 
		-nn "branch 2 Bend" -smn -90 -smx 90 -at "float" -p "houdiniAssetParm";
	setAttr ".t" -type "double3" -3.9645986557006836 0 2.8804492950439453 ;
	setAttr ".r" -type "double3" 0 67.919620017649365 0 ;
	setAttr ".otlFilePath" -type "string" "C:/Users/hunte/Documents/houdini19.5/otls/object_hunte.dev.Tree_subnet.1.0.hdanc";
	setAttr ".assetName" -type "string" "hunte::dev::Object/Tree_subnet::1.0";
	setAttr -cb on ".houdiniAssetParm_s__tuple0" 1;
	setAttr -cb on ".houdiniAssetParm_s__tuple1" 1;
...
createNode transform -n "lineartaper2_0" -p "|hunte__dev__Tree_subnet__1_03|tube_object1";
	rename -uid "D4FA81FE-4010-63FE-87D5-6DB62444292D";
	setAttr ".t" -type "double3" 1.4134810172798975 -0.53233909606933594 -1.4678178288080721 ;
	setAttr ".r" -type "double3" -15.500028527161842 33.323424971430391 -2.4063418783766477 ;
createNode mesh -n "lineartaper2_0Shape" -p "|hunte__dev__Tree_subnet__1_03|tube_object1|lineartaper2_0";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
createNode houdiniAsset -n "hunte__dev__Tree_subnet__1_04";
	...
	addAttr -is true -ci true -sn "houdiniAssetParm_bend2" -ln "houdiniAssetParm_bend2" 
		-nn "branch 2 Bend" -smn -90 -smx 90 -at "float" -p "houdiniAssetParm";
	setAttr ".r" -type "double3" 0 -22.91143400587795 0 ;
	setAttr ".otlFilePath" -type "string" "C:/Users/hunte/Documents/houdini19.5/otls/object_hunte.dev.Tree_subnet.1.0.hdanc";
	setAttr ".assetName" -type "string" "hunte::dev::Object/Tree_subnet::1.0";
	setAttr -cb on ".houdiniAssetParm_s__tuple0" 1;
	setAttr -cb on ".houdiniAssetParm_s__tuple1" 1;
...
createNode transform -n "lineartaper2_0" -p "|hunte__dev__Tree_subnet__1_04|tube_object1";
	rename -uid "4793C9FB-49D8-6964-E577-088E567B65CF";
	setAttr ".t" -type "double3" -5.9038305694706281 -1.6942923174747488 5.3716834376374916 ;
	setAttr ".r" -type "double3" 0 0 15.550231082705563 ;
createNode mesh -n "lineartaper2_0Shape" -p "|hunte__dev__Tree_subnet__1_04|tube_object1|lineartaper2_0";
...
connectAttr "hunte__dev__Tree_subnet__1_01.outputObjects[0].outputObjectScale" "|hunte__dev__Tree_subnet__1_01|tube_object1.s"
		;
connectAttr "groupParts2.og" "|hunte__dev__Tree_subnet__1_01|tube_object1|lineartaper2_0|lineartaper2_0Shape.i"
		;
...
connectAttr "hunte__dev__Tree_subnet__1_02.outputObjects[0].outputObjectTranslate" "|hunte__dev__Tree_subnet__1_02|tube_object1.t"
		;
connectAttr "hunte__dev__Tree_subnet__1_02.outputObjects[0].outputObjectRotate" "|hunte__dev__Tree_subnet__1_02|tube_object1.r"
		;
connectAttr "hunte__dev__Tree_subnet__1_02.outputObjects[0].outputObjectScale" "|hunte__dev__Tree_subnet__1_02|tube_object1.s"
		;
connectAttr "groupParts4.og" "|hunte__dev__Tree_subnet__1_02|tube_object1|lineartaper2_0|lineartaper2_0Shape.i"
		;
connectAttr "groupId3.id" "|hunte__dev__Tree_subnet__1_02|tube_object1|lineartaper2_0|lineartaper2_0Shape.iog.og[0].gid"
		;
connectAttr "group1.mwc" "|hunte__dev__Tree_subnet__1_02|tube_object1|lineartaper2_0|lineartaper2_0Shape.iog.og[0].gco"
		;
connectAttr "groupId4.id" "|hunte__dev__Tree_subnet__1_02|tube_object1|lineartaper2_0|lineartaper2_0Shape.iog.og[1].gid"
		;
connectAttr "group2.mwc" "|hunte__dev__Tree_subnet__1_02|tube_object1|lineartaper2_0|lineartaper2_0Shape.iog.og[1].gco"
		;
connectAttr ":time1.o" "hunte__dev__Tree_subnet__1_03.inTime";
connectAttr "hunte__dev__Tree_subnet__1_03.outputObjects[0].outputObjectTranslate" "|hunte__dev__Tree_subnet__1_03|tube_object1.t"
		;
connectAttr "hunte__dev__Tree_subnet__1_03.outputObjects[0].outputObjectRotate" "|hunte__dev__Tree_subnet__1_03|tube_object1.r"
		;
connectAttr "hunte__dev__Tree_subnet__1_03.outputObjects[0].outputObjectScale" "|hunte__dev__Tree_subnet__1_03|tube_object1.s"
		;
connectAttr "groupParts6.og" "|hunte__dev__Tree_subnet__1_03|tube_object1|lineartaper2_0|lineartaper2_0Shape.i"
		;
connectAttr "groupId5.id" "|hunte__dev__Tree_subnet__1_03|tube_object1|lineartaper2_0|lineartaper2_0Shape.iog.og[0].gid"
		;
connectAttr "group1.mwc" "|hunte__dev__Tree_subnet__1_03|tube_object1|lineartaper2_0|lineartaper2_0Shape.iog.og[0].gco"
		;
connectAttr "groupId6.id" "|hunte__dev__Tree_subnet__1_03|tube_object1|lineartaper2_0|lineartaper2_0Shape.iog.og[1].gid"
		;
connectAttr "group2.mwc" "|hunte__dev__Tree_subnet__1_03|tube_object1|lineartaper2_0|lineartaper2_0Shape.iog.og[1].gco"
		;
connectAttr ":time1.o" "hunte__dev__Tree_subnet__1_04.inTime";
connectAttr "hunte__dev__Tree_subnet__1_04.outputObjects[0].outputObjectTranslate" "|hunte__dev__Tree_subnet__1_04|tube_object1.t"
		;
connectAttr "hunte__dev__Tree_subnet__1_04.outputObjects[0].outputObjectRotate" "|hunte__dev__Tree_subnet__1_04|tube_object1.r"
		;
connectAttr "hunte__dev__Tree_subnet__1_04.outputObjects[0].outputObjectScale" "|hunte__dev__Tree_subnet__1_04|tube_object1.s"
		;
connectAttr "groupParts8.og" "|hunte__dev__Tree_subnet__1_04|tube_object1|lineartaper2_0|lineartaper2_0Shape.i"
		;
connectAttr "groupId7.id" "|hunte__dev__Tree_subnet__1_04|tube_object1|lineartaper2_0|lineartaper2_0Shape.iog.og[0].gid"
		;
connectAttr "group1.mwc" "|hunte__dev__Tree_subnet__1_04|tube_object1|lineartaper2_0|lineartaper2_0Shape.iog.og[0].gco"
		;
connectAttr "groupId8.id" "|hunte__dev__Tree_subnet__1_04|tube_object1|lineartaper2_0|lineartaper2_0Shape.iog.og[1].gid"
		;
connectAttr "group2.mwc" "|hunte__dev__Tree_subnet__1_04|tube_object1|lineartaper2_0|lineartaper2_0Shape.iog.og[1].gco"
		;
...
connectAttr "|hunte__dev__Tree_subnet__1_01|tube_object1|lineartaper2_0|lineartaper2_0Shape.iog.og[0]" "group1.dsm"
		 -na;
connectAttr "|hunte__dev__Tree_subnet__1_02|tube_object1|lineartaper2_0|lineartaper2_0Shape.iog.og[0]" "group1.dsm"
		 -na;
connectAttr "|hunte__dev__Tree_subnet__1_03|tube_object1|lineartaper2_0|lineartaper2_0Shape.iog.og[0]" "group1.dsm"
		 -na;
connectAttr "|hunte__dev__Tree_subnet__1_04|tube_object1|lineartaper2_0|lineartaper2_0Shape.iog.og[0]" "group1.dsm"
		 -na;
...
connectAttr "|hunte__dev__Tree_subnet__1_01|tube_object1|lineartaper2_0|lineartaper2_0Shape.iog.og[1]" "group2.dsm"
		 -na;
connectAttr "|hunte__dev__Tree_subnet__1_02|tube_object1|lineartaper2_0|lineartaper2_0Shape.iog.og[1]" "group2.dsm"
		 -na;
connectAttr "|hunte__dev__Tree_subnet__1_03|tube_object1|lineartaper2_0|lineartaper2_0Shape.iog.og[1]" "group2.dsm"
		 -na;
connectAttr "|hunte__dev__Tree_subnet__1_04|tube_object1|lineartaper2_0|lineartaper2_0Shape.iog.og[1]" "group2.dsm"
		 -na;
...
connectAttr "|hunte__dev__Tree_subnet__1_01|tube_object1|lineartaper2_0|lineartaper2_0Shape.iog" ":initialShadingGroup.dsm"
		 -na;
connectAttr "|hunte__dev__Tree_subnet__1_02|tube_object1|lineartaper2_0|lineartaper2_0Shape.iog" ":initialShadingGroup.dsm"
		 -na;
connectAttr "|hunte__dev__Tree_subnet__1_03|tube_object1|lineartaper2_0|lineartaper2_0Shape.iog" ":initialShadingGroup.dsm"
		 -na;
connectAttr "|hunte__dev__Tree_subnet__1_04|tube_object1|lineartaper2_0|lineartaper2_0Shape.iog" ":initialShadingGroup.dsm"
		 -na;
