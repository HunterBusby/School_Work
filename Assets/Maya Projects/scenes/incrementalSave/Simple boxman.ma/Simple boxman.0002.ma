...
//Last modified: Wed, Jan 17, 2024 05:36:49 PM
//Codeset: 1252
requires maya "2024";
...
fileInfo "UUID" "AD4A7AAF-4864-4282-501E-B9AD01E9ABEC";
createNode transform -s -n "persp";
	rename -uid "E1263623-407A-D287-52AD-38AC5A2C7DB5";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -38.142474165511537 17.656250906858297 1.5125450511559992 ;
	setAttr ".r" -type "double3" -372.33835273006008 629.79999999998222 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "4203EAA7-4B04-65CE-9161-FBBC7835DD46";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 32.82960126108842;
...
createNode transform -n "Hip";
	...
	setAttr ".t" -type "double3" 0 0 0.89730760369670304 ;
