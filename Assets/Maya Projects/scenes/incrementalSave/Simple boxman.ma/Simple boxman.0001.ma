...
//Last modified: Wed, Jan 17, 2024 05:36:42 PM
//Codeset: 1252
requires maya "2024";
...
fileInfo "UUID" "37D6933E-4493-EF45-A60F-939B6EC41E16";
createNode transform -s -n "persp";
	rename -uid "E1263623-407A-D287-52AD-38AC5A2C7DB5";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -42.494153129652425 28.082150517203935 4.0436953519221319 ;
	setAttr ".r" -type "double3" -385.53835273005939 633.79999999998347 -4.7991059259842418e-14 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "4203EAA7-4B04-65CE-9161-FBBC7835DD46";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 40.455713034148303;
...
createNode transform -n "LThigh1" -p "Hip";
	...
	setAttr ".t" -type "double3" 0 0 2.333649668606784 ;
	setAttr ".rp" -type "double3" 0 14.041473388671875 -2.279559105131264 ;
	setAttr ".sp" -type "double3" 0 14.041473388671875 -2.279559105131264 ;
