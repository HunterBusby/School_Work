...
//Last modified: Tue, Dec 05, 2023 10:49:36 PM
//Codeset: 1252
...
fileInfo "UUID" "32966C7F-4142-CEA1-0AAE-0589DF6B1792";
createNode transform -s -n "persp";
	rename -uid "0B68FA2E-43FB-0834-0AB7-EBBCAFC3FD4F";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 25.648170139170482 8.3037676220879639 3.3152624558558532 ;
	setAttr ".r" -type "double3" 0.86164726987344575 439.799999999492 2.8063494802393689e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "0F646CF5-4FFC-0BE3-E207-F4BF66232120";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 29.019323848125484;
...
createNode animCurveTA -n "PALbot_head_ctrl_rotateX1";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 0 16 0 19 0 22 14.693965809955401 25 14.693965809955401;
