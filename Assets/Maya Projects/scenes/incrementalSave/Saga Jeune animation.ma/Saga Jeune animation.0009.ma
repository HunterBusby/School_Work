...
//Last modified: Wed, Dec 06, 2023 01:02:37 PM
//Codeset: 1252
...
fileInfo "UUID" "2BABB3EA-4286-2EC5-1FF9-3A88FBC4BAAD";
createNode transform -s -n "persp";
	rename -uid "0B68FA2E-43FB-0834-0AB7-EBBCAFC3FD4F";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 50.08658865020918 5.3004655365166684 0.45106102123557901 ;
	setAttr ".r" -type "double3" 3.8616472699691906 447.79999999934518 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "0F646CF5-4FFC-0BE3-E207-F4BF66232120";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 50.13197291102977;
