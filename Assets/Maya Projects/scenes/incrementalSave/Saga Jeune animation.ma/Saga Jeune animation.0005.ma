...
//Last modified: Tue, Dec 05, 2023 10:35:44 PM
//Codeset: 1252
...
fileInfo "UUID" "2EFCF085-472E-CB1C-11E0-50953085C9B6";
createNode transform -s -n "persp";
	rename -uid "0B68FA2E-43FB-0834-0AB7-EBBCAFC3FD4F";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 13.430203540591894 8.8911515167031983 -16.301768100473243 ;
	setAttr ".r" -type "double3" 17.061647269884801 492.99999999961238 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "0F646CF5-4FFC-0BE3-E207-F4BF66232120";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 16.798085287753096;
...
createNode reference -n "PALBotRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"rotateY" " -av -49.53069742006790932"
		2 "|PALBot:PALBOT_GRP|PALBot:PALbot_LOC|PALBot:PALbot_CTRLs|PALBot:PALbot_MAIN|PALBot:PALbot_root|PALBot:PALbot_cog_ctrl_offset|PALBot:PALbot_cog_ctrl|PALBot:PALbot_cog_secondary_ctrl_offset1|PALBot:PALbot_cog_secondary_ctrl|PALBot:PALbot_chestup_ctrl_offset|PALBot:PALbot_chestUp_ctrl|PALBot:PALbot_chestUp_secondary_ctrl_offset|PALBot:PALbot_chestUp_secondary_ctrl|PALBot:PALbot_L_Clavicle_offset|PALBot:PALbot_L_Clavicle_ctrl|PALBot:PALbot_L_Arm_FOLLOW|PALBot:PALbot_L_ShoulderRotate_offset|PALBot:PALbot_L_ShoulderRotate_ctrl|PALBot:PALbot_L_Arm_offset|PALBot:PALbot_L_Arm_ctrl" 
		"rotateZ" " -av -77.33334086489479375"
...
createNode animCurveTL -n "PALbot_R_IK_Foot_ctrl_translateX1";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 0 16 0 19 0 22 0 25 -1.0004114209531167;
createNode animCurveTL -n "PALbot_R_IK_Foot_ctrl_translateY1";
	rename -uid "253AC535-41AB-AE2B-30CD-33A7A4CD8493";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 0 16 0 19 0 22 1.2254557298873858 25 5.4806762511399398;
createNode animCurveTL -n "PALbot_R_IK_Foot_ctrl_translateZ1";
	rename -uid "D1C10C3D-4A14-0980-32DC-3C8F942ECA07";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 -3.0072502670617709 16 -3.0072502670617709
		 19 -3.0072502670617709 22 -3.0072502670617709 25 -3.6566806562689584;
createNode animCurveTA -n "PALbot_R_IK_Foot_ctrl_rotateX1";
	rename -uid "42609A35-490B-F58A-59BB-BFAD44E337F7";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 0 16 0 19 0 22 41.706803152329037 25 102.48959888351726;
...
createNode animCurveTA -n "PALbot_R_FK_Elbow_ctrl_rotateX1";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  0 -82.842917925361974 16 -45.108285928243511
...
createNode animCurveTL -n "PALbot_R_FK_Elbow_ctrl_translateX1";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  0 0 16 0 19 0 20 0 22 0 25 0;
...
createNode animCurveTA -n "PALbot_L_Arm_ctrl_rotateY2";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  0 -72.29825763745842 16 -171.18352338409932
...
createNode animCurveTA -n "PALbot_L_Arm_ctrl_rotateZ2";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  0 0 16 -21.551606902799197 19 -21.551606902799197
		 21 -6.5656749220375019 22 -1.3205987287709697 25 -19.359543445396731;
createNode animCurveTL -n "PALbot_L_Arm_ctrl_translateX2";
	rename -uid "5F6B5158-46FD-3C60-B9B1-D08CCD71EEC2";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  0 0 16 0 19 0 21 0 22 0 25 0;
...
createNode animCurveTA -n "PALbot_chestUp_ctrl_rotateX1";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 7.5154335156577003 16 -1.919700439938907
		 19 16.096443984455977 22 16.096443984455977 25 49.933236979353538;
createNode animCurveTA -n "PALbot_chestUp_ctrl_rotateY1";
	rename -uid "5D146426-4013-7125-01B5-AFA3D2868B7E";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 0.15621542728432392 16 0.15621542728432411
		 19 7.7144828823825584 22 7.7144828823825584 25 7.7144828823825611;
createNode animCurveTA -n "PALbot_chestUp_ctrl_rotateZ1";
	rename -uid "35A68C36-4DB7-4B4C-D3E8-DDAD039E810B";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 0.20611809981856194 16 0.20611809981856208
		 19 -0.36301979797634448 22 -0.36301979797634448 25 -0.36301979797634726;
createNode animCurveTL -n "PALbot_chestUp_ctrl_translateX1";
	rename -uid "D05FD0D2-46BE-E378-1E14-56B224D27BCC";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 0 16 0 19 -0.046578703117553737 22 -0.046578703117553737
		 25 -0.046578703117553737;
...
createNode animCurveTL -n "PALbot_chestUp_ctrl_translateZ1";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 0 16 0 19 0.49999552408098513 22 0.49999552408098513
		 25 0.49999552408098513;
...
createNode animCurveTA -n "PALbot_L_ShoulderRotate_ctrl_rotateZ2";
	...
	setAttr -s 5 ".ktv[0:4]"  0 10.5569749046432 16 -19.300753794681931
		 19 -44.945648672765984 22 -112.47448173102497 25 -112.47448173102497;
...
createNode animCurveTA -n "PALbot_L_Clavicle_ctrl_rotateY1";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 0 16 0 19 0 22 0 25 -35.595513439869848;
...
createNode animCurveTA -n "PALbot_L_Arm_ctrl_rotateY3";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 0 16 0 19 7.319905116978604 22 -20.876809190340481
		 25 -49.530697420067909;
createNode animCurveTA -n "PALbot_L_Arm_ctrl_rotateZ3";
	rename -uid "B545DAC6-456F-FC4B-290F-4095710B13CF";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 0 16 -26.69346552462655 19 -8.7487022783433321
		 22 -57.556418780863986 25 -77.333340864894794;
...
createNode animCurveTA -n "PALbot_L_ShoulderRotate_ctrl_rotateZ3";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 0 16 -104.87536543402277 19 -141.23198311370425
		 22 -289.27539682766809 25 -289.27539682766809;
