...
//Last modified: Sat, Sep 30, 2023 10:41:59 AM
//Codeset: 1252
...
fileInfo "UUID" "14792105-4239-AD97-3DBE-C682A3B9EECE";
createNode transform -s -n "persp";
	rename -uid "04C1C0C8-454E-A89A-BBF1-1D8D024FA5CE";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 14.645354271561322 4.6709072444235202 3.0637590260103433 ;
	setAttr ".r" -type "double3" -10.538352721753204 1155.3999999993086 -3.1544439826841605e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "45E14E17-4A2A-BB26-4D8B-B9AE84D9D9DB";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 15.274830435149093;
...
createNode transform -s -n "side";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1000.1 1.6613195361932565 -1.3351974921122534 ;
...
createNode reference -n "Ultimate_Walker_RigRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"translate" " -type \"double3\" 0 -0.021666382258401375 -0.15559340228506593"
		2 "|Ultimate_Walker_Rig:AniM_walker_Main|Ultimate_Walker_Rig:Rig_Leg_grp|Ultimate_Walker_Rig:walker_rt_leg_rig_grp|Ultimate_Walker_Rig:walker_rt_heel_ik_ctrl_frzGrp|Ultimate_Walker_Rig:walker_rt_heel_ik_ctrl" 
		"translateX" " -av"
		2 "|Ultimate_Walker_Rig:AniM_walker_Main|Ultimate_Walker_Rig:Rig_Leg_grp|Ultimate_Walker_Rig:walker_rt_leg_rig_grp|Ultimate_Walker_Rig:walker_rt_heel_ik_ctrl_frzGrp|Ultimate_Walker_Rig:walker_rt_heel_ik_ctrl" 
		"translateY" " -av"
...
createNode animCurveTL -n "CTRL_Main_translateY";
	...
	setAttr -s 21 ".kit[0:20]"  9 9 9 9 9 9 9 9 
		9 18 18 18 18 9 18 18 18 18 18 18 18;
...
createNode animCurveTU -n "walker_rt_heel_ik_ctrl_footRoll";
	...
	setAttr -s 19 ".kit[8:18]"  18 9 9 18 18 9 18 18 
		18 18 18;
	setAttr -s 19 ".kot[8:18]"  18 5 9 18 18 9 18 18 
		18 18 18;
createNode animCurveTU -n "walker_rt_heel_ik_ctrl_footBreak";
	...
	setAttr -s 21 ".ktv[0:20]"  1 55 4 55 7 55 10 55 13 55 16 55 17 0 19 0
		 20 -18.1 22 0 23 1.6088888888889041 25 0 26 0 35 18 39 20 43 -10 50 0 51 0 75 0 78 0
		 84 0;
	setAttr -s 21 ".kit[6:20]"  18 9 18 9 18 9 9 18 
		18 9 18 18 18 18 18;
	setAttr -s 21 ".kot[6:20]"  18 9 18 9 18 5 9 18 
		18 9 18 18 18 18 18;
createNode animCurveTL -n "walker_rt_heel_ik_ctrl_translateY";
	rename -uid "73F84650-4604-19A4-ACE8-7DADE9EE1128";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 21 ".ktv[0:20]"  1 -0.032844329404068111 4 -0.032844329404068111
		 ...
		 39 0.0075924476607645008 43 0.029164570402022694 50 0 51 0 75 0 78 0.66963862182113787
		 84 0.66963862182113787;
	setAttr -s 21 ".kit[6:20]"  18 9 18 9 18 9 9 18 
		18 9 18 18 18 18 18;
	setAttr -s 21 ".kot[6:20]"  18 9 18 9 18 5 9 18 
		18 9 18 18 18 18 18;
createNode animCurveTL -n "walker_rt_heel_ik_ctrl_translateZ";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 20 ".ktv[0:19]"  1 0.93162235471218269 4 0.61918437823016181
		 ...
		 26 0 35 -0.15559340228506593 43 -0.24076444278650344 50 0 51 0 75 0 78 1.1110691141102058
		 84 -1.4297962230815333;
	setAttr -s 20 ".kit[6:19]"  18 9 18 9 18 9 9 18 
		9 18 18 18 18 18;
	setAttr -s 20 ".kot[6:19]"  18 9 18 9 18 5 9 18 
		9 18 18 18 18 18;
...
createNode animCurveTL -n "CTRL_Main_translateZ";
	...
	setAttr -s 17 ".kit[9:16]"  18 18 18 18 9 18 18 18;
	setAttr -s 17 ".kot[9:16]"  18 18 18 18 9 18 18 18;
createNode animCurveTL -n "walker_lf_heel_ik_ctrl_translateX";
	rename -uid "6C08E794-44CF-8039-514E-FA8D32038BE7";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 14 ".ktv[0:13]"  1 0 4 0 7 0 10 0 13 0 16 -1.4411479270790191e-17
		 19 0 22 0 25 0 26 0 51 0 75 0 78 -1.4327644988790339e-16 84 -2.5219355161780613e-17;
	setAttr -s 14 ".kit[10:13]"  18 18 18 18;
	setAttr -s 14 ".kot[8:13]"  5 9 18 18 18 18;
createNode animCurveTL -n "walker_lf_heel_ik_ctrl_translateY";
	rename -uid "13D4F3E5-4F30-23A0-B6ED-2DB871DE2E28";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 19 ".ktv[0:18]"  1 0.01384857339934753 4 0.01384857339934753
		 5 -0.12826695488449441 7 0.42437690689486068 10 0.56052138375433547 13 -0.033 16 -0.033
		 19 -0.033 22 -0.033 25 0.014 26 0 35 -0.022 39 0.008 43 0.029 50 0 51 0 75 0 78 0.64211089344191363
		 84 0.64211089344191363;
	setAttr -s 19 ".kit[2:18]"  18 9 9 9 9 9 9 9 
		9 18 18 18 18 18 18 18 18;
	setAttr -s 19 ".kot[2:18]"  18 9 9 9 9 9 9 5 
		9 18 18 18 18 18 18 18 18;
createNode animCurveTL -n "walker_lf_heel_ik_ctrl_translateZ";
	rename -uid "E4001EFD-400A-2C59-7AEA-66BA9EE83B26";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 18 ".ktv[0:17]"  1 -1.0483909399442253 4 -1.1822588747797187
		 5 -1.3924710652937988 7 -0.67356072240484344 10 1.1035140832048467 13 0.932 16 0.66232134129755604
		 19 -0.203 22 -0.606 25 -1.048 26 0 35 -0.156 43 -0.241 50 0 51 0 75 0 78 -1.1699409983977256
		 84 0.70063423478895648;
	setAttr -s 18 ".kit[2:17]"  18 9 9 9 9 9 9 9 
		9 18 18 18 18 18 18 18;
	setAttr -s 18 ".kot[2:17]"  18 9 9 9 9 9 9 5 
		9 18 18 18 18 18 18 18;
...
createNode animCurveTL -n "walker_rt_heel_ik_ctrl_translateX";
	...
	setAttr -s 16 ".kit[8:15]"  18 9 9 18 18 18 18 18;
	setAttr -s 16 ".kot[8:15]"  18 5 9 18 18 18 18 18;
...
createNode animCurveTU -n "walker_rt_heel_ik_ctrl_pvControl";
	...
	setAttr -s 16 ".kot[8:15]"  5 5 9 5 5 5 5 5;
...
createNode animCurveTA -n "walker_lf_heel_ik_ctrl_rotateX";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 14 ".ktv[0:13]"  1 0 4 0 7 0 10 0 13 0 16 0 19 0 22 0 25 0
		 26 0 51 0 75 0 78 0 84 0;
	setAttr -s 14 ".kit[10:13]"  18 18 18 18;
	setAttr -s 14 ".kot[8:13]"  5 9 18 18 18 18;
...
createNode animCurveTU -n "walker_lf_heel_ik_ctrl_pvControl";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 14 ".ktv[0:13]"  1 1 4 1 7 1 10 1 13 1 16 1 19 1 22 1 25 1
		 26 1 51 1 75 1 78 1 84 1;
	setAttr -s 14 ".kot[8:13]"  5 9 5 5 5 5;
createNode animCurveTU -n "walker_lf_heel_ik_ctrl_footRoll";
	...
	setAttr -s 18 ".ktv[0:17]"  1 30.800000000000004 4 51.800000000000004
		 ...
		 43 50 50 0 51 0 75 0 78 0 84 0;
