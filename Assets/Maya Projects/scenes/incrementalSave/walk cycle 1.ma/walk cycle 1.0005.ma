...
//Last modified: Sat, Sep 30, 2023 10:24:40 AM
//Codeset: 1252
...
fileInfo "UUID" "275331F5-4C30-641C-E5AE-5F92B9C03BCD";
createNode transform -s -n "persp";
	rename -uid "04C1C0C8-454E-A89A-BBF1-1D8D024FA5CE";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 17.87622600333119 1.4051624229918842 2.7491815173371172 ;
	setAttr ".r" -type "double3" -1.5383527233307059 799.39999999977636 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "45E14E17-4A2A-BB26-4D8B-B9AE84D9D9DB";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 18.323097665200702;
...
createNode transform -s -n "side";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1000.1 1.0882939822330262 -0.71198569644731191 ;
...
createNode script -n "sceneConfigurationScriptNode";
	...
	setAttr ".b" -type "string" "playbackOptions -min 26 -max 51 -ast 0 -aet 200 ";
	setAttr ".st" 6;
...
createNode animCurveTL -n "walker_rt_heel_ik_ctrl_translateY";
	...
	setAttr -s 20 ".ktv[0:19]"  1 -0.032844329404068111 4 -0.032844329404068111
		 ...
		 19 0.424 20 0.34651464858356495 22 0.561 23 0.41726536457034968 25 -0.033 26 0 39 0.0075924476607645008
...
createNode animCurveTL -n "walker_lf_heel_ik_ctrl_translateY";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 17 ".ktv[0:16]"  1 0.01384857339934753 4 0.01384857339934753
		 5 -0.12826695488449441 7 0.42437690689486068 10 0.56052138375433547 13 -0.033 16 -0.033
		 19 -0.033 22 -0.033 25 0.014 26 0 39 -0.041547453044329274 50 0 51 0 75 0 78 0.64211089344191363
		 84 0.64211089344191363;
