...
//Last modified: Wed, Sep 27, 2023 12:35:01 PM
//Codeset: 1252
...
fileInfo "UUID" "FA279799-457F-8F9F-F5E7-F8A6729521E5";
createNode transform -s -n "persp";
	rename -uid "04C1C0C8-454E-A89A-BBF1-1D8D024FA5CE";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 14.978472759383051 1.329859236616816 -0.44750886243112076 ;
	setAttr ".r" -type "double3" 0.26164727739323429 806.19999999992842 -3.7493015045884892e-16 ;
...
createNode transform -s -n "side";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1000.1 1.8197196157041697 -0.46716145280720545 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "D233DBF4-4C13-92AD-186F-3885FFA8B2FF";
	setAttr -s 4 ".lnk";
	setAttr -s 4 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "22FE20F0-466A-429C-291C-EEBA9922B689";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "76F04B2C-4DF6-62B1-0D73-0B9EF850C1E0";
createNode displayLayerManager -n "layerManager";
	rename -uid "9C32329B-4FEB-26D7-AA04-81BA19B444E4";
createNode displayLayer -n "defaultLayer";
	rename -uid "75E8A904-4FFD-C41B-4F50-7F80DDF36A76";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "DAE0817D-4B5C-7D75-3D71-81A2ED85320F";
