...
//Last modified: Tue, Oct 03, 2023 03:25:17 PM
//Codeset: 1252
...
fileInfo "UUID" "14E77006-4856-7A6C-5630-3A8F8D738832";
...
createNode animCurveTL -n "CTRL_Main_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 28 ".ktv[0:27]"  1 -0.13441104219708588 4 -0.25042991905451384
	...
	setAttr -s 28 ".kot[0:27]"  9 9 9 9 9 9 9 9 
		...
		18 18 18;
	setAttr -s 28 ".kix[19:27]"  1 1 0.46995512999591621 1 0.76921501370565959 
		1 0.51572866694882125 1 1;
	setAttr -s 28 ".kiy[19:27]"  0 0 -0.88269030570779539 0 0.63899003332587423 
		0 -0.85675197232757605 0 0;
	setAttr -s 28 ".kox[19:27]"  1 1 0.46995512999591615 1 0.76921501370565959 
		1 0.51572866694882136 1 1;
	setAttr -s 28 ".koy[19:27]"  0 0 -0.88269030570779539 0 0.63899003332587423 
		0 -0.85675197232757616 0 0;
...
createNode animCurveTL -n "walker_rt_heel_ik_ctrl_translateY";
	...
	setAttr -s 28 ".ktv[0:27]"  1 -0.032844329404068111 4 -0.032844329404068111
		 ...
		 92 0.6569195700925845 95 -0.1442433028297192 98 0 101 0;
	setAttr -s 28 ".kit[0:27]"  9 9 9 9 9 9 18 9 
		18 9 18 9 9 18 18 9 18 18 18 18 18 18 18 18 18 
		18 18 18;
	setAttr -s 28 ".kot[0:27]"  9 9 9 9 9 9 18 9 
...
createNode animCurveTL -n "walker_rt_heel_ik_ctrl_translateZ";
	...
	setAttr -s 27 ".ktv[0:26]"  1 0.93162235471218269 4 0.61918437823016181
		 ...
		 89 1.3069894644296274 92 1.5937214400018196 95 1.2563897040345338 98 0.822 101 -0.192;
...
createNode animCurveTL -n "walker_lf_heel_ik_ctrl_translateY";
	...
	setAttr -s 25 ".ktv[0:24]"  1 0.01384857339934753 4 0.01384857339934753
		 ...
		 83 0 86 0 89 0 92 0.14336598778609644 95 0.45539784355583596 98 0.343 101 0.008;
...
createNode animCurveTL -n "walker_rt_heel_ik_ctrl_translateX";
	...
	setAttr -s 22 ".ktv[0:21]"  1 0 4 -1.307049462830552e-16 7 -7.5901357066490771e-17
		 ...
		 95 -6.8181241972273345e-17 101 -6.8181241972273345e-17;
...
createNode animCurveTA -n "walker_rt_heel_ik_ctrl_rotateX";
	...
	setAttr -s 22 ".ktv[0:21]"  1 0 4 0 7 0 10 0 13 0 16 0 19 0 22 0 23 0
		 25 0 26 0 50 0 51 0 76 0 77 0 80 0 83 0 86 0 89 0 92 0 95 0 101 0;
	setAttr -s 22 ".kit[0:21]"  9 9 9 9 9 9 9 9 
		18 9 9 18 18 18 18 18 18 18 18 18 18 18;
	setAttr -s 22 ".kot[0:21]"  9 9 9 9 9 9 9 9 
		18 5 9 18 5 18 18 18 18 18 18 18 18 18;
...
createNode animCurveTU -n "walker_rt_heel_ik_ctrl_pvControl";
	...
	setAttr -s 22 ".ktv[0:21]"  1 1 4 1 7 1 10 1 13 1 16 1 19 1 22 1 23 1
		 25 1 26 1 50 1 51 1 76 1 77 1 80 1 83 1 86 1 89 1 92 1 95 1 101 1;
...
createNode animCurveTU -n "walker_lf_heel_ik_ctrl_footBreak";
	...
	setAttr -s 26 ".ktv[0:25]"  1 55 4 55 5 0 6 -11.8 7 0 10 0 13 0 16 0
		 ...
		 86 54.7 89 25.3 92 -2.5 95 -2.5 98 0 101 -32;
