...
//Last modified: Fri, Nov 10, 2023 05:13:41 PM
//Codeset: 1252
...
fileInfo "UUID" "430F3137-4CF8-2F32-C8A4-70A5B0D9D3B6";
createNode transform -s -n "persp";
	rename -uid "A4E4D85E-46E1-161C-0A10-C88E8DA5A22A";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 24.229418995829363 7.0853180951776951 24.7045468614618 ;
	setAttr ".r" -type "double3" -9.9383527294887077 24.999999999976119 -4.3866922569736796e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "DD306209-4CBA-8C33-032F-53A812EB31BF";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 33.733172009744244;
...
createNode transform -n "uvunwrap1_0" -p "RockGeo";
	...
	setAttr ".t" -type "double3" -0.89811406660199955 1.8904170120238737 -3.8521446796978203 ;
...
createNode transform -n "pasted__uvunwrap1_0" -p "|Rock2|pasted__hunte__dev__NewRockGeo__1_01|pasted__RockGeo";
	...
	setAttr ".t" -type "double3" -2.0573251145804132 1.9740718495268768 -2.3327473919414539 ;
...
createNode transform -n "pasted__pasted__uvunwrap1_0" -p "|Rock4|pasted__Rock3|pasted__pasted__hunte__dev__NewRockGeo__1_01|pasted__pasted__RockGeo";
	...
	setAttr ".t" -type "double3" -1.2740424808539297 1.8904170120238737 -3.8521446796978212 ;
...
createNode transform -n "pasted__pasted__uvunwrap1_0" -p "|group4|pasted__Rock3";
	...
	setAttr ".t" -type "double3" -0.89811406660199966 1.8904170120238739 -3.8521446796978198 ;
...
createNode transform -n "camera1";
	...
	setAttr ".t" -type "double3" 24.163451304734934 5.8798940319907782 0 ;
	setAttr ".r" -type "double3" 0 90 0 ;
