...
//Last modified: Thu, Nov 09, 2023 11:43:59 PM
//Codeset: 1252
...
fileInfo "UUID" "79D59529-433C-5CDD-D2C5-36AACD2966F3";
createNode transform -s -n "persp";
	rename -uid "A4E4D85E-46E1-161C-0A10-C88E8DA5A22A";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -15.456326935627599 9.2972505256729168 -10.431369675122179 ;
	setAttr ".r" -type "double3" -23.738352729597207 236.20000000000022 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "DD306209-4CBA-8C33-032F-53A812EB31BF";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 20.809225539572132;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "278CEB05-484E-70B4-47F6-C699777293ED";
	setAttr -s 6 ".lnk";
	setAttr -s 6 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "0055E89D-48BE-D953-FEFD-AD99FEE32640";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "D7081823-4D58-AFB9-9C21-7BA899033C9A";
createNode displayLayerManager -n "layerManager";
	rename -uid "DB40AA6C-4AE5-D3FF-6564-C0A8ED6D72CA";
createNode displayLayer -n "defaultLayer";
	rename -uid "D9FC099B-4C94-1D81-9449-318F603795A2";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "40EFA549-4A53-6187-91CC-18A55928BB26";
...
createNode substanceNode -n "substanceNode1";
	...
	addAttr -r false -ci true -h true -k true -sn "input_moon_colorr" -ln "input_moon_colorR" 
		-dv 0.7098039984703064 -smn 0 -smx 0 -at "float" -p "input_moon_color";
...
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "70EEEE10-4BF2-5A1E-ED96-C98A67B9F33C";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -1529.6988023021024 -2668.1273489633136 ;
	setAttr ".tgi[0].vh" -type "double2" 2948.7299095535686 2329.6814979653345 ;
	...
	setAttr ".tgi[0].ni[4].x" 768.5714111328125;
	setAttr ".tgi[0].ni[4].y" -764.28570556640625;
	...
	setAttr ".tgi[0].ni[15].x" -565.71429443359375;
...
connectAttr "hunte__dev__NewRockGeo__1_01.outputObjects[0].outputObjectScale" "RockGeo.s"
		;
connectAttr "hunte__dev__NewRockGeo__1_01.outputObjects[0].outputGeos[0].outputParts[0].outputPartMeshData" "uvunwrap1_0Shape.i"
		;
...
connectAttr "set1.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[1].dn"
		;
connectAttr "Moon_Surface_height.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[2].dn"
		;
connectAttr "Moon_Surface_metallic.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[3].dn"
		;
connectAttr "displacementShader1.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[4].dn"
		;
connectAttr "MoonSurface.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[5].dn"
		;
connectAttr "file7.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[6].dn"
		;
connectAttr "Moon_Surface_basecolor.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[7].dn"
		;
connectAttr "Moon_Surface_ambientocclusion.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[8].dn"
		;
...
connectAttr "file8.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[14].dn"
		;
connectAttr "substanceNode1.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[15].dn"
		;
connectAttr "file3.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[16].dn"
		;
connectAttr "Moon_Surface_normal.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[17].dn"
		;
connectAttr "file5.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[18].dn"
		;
connectAttr "Moon_Surface_roughness.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[19].dn"
		;
