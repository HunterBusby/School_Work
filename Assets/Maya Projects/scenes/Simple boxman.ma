...
//Last modified: Wed, Jan 17, 2024 05:57:20 PM
//Codeset: 1252
requires maya "2024";
...
fileInfo "UUID" "BE19FBFF-49D9-FFAB-4845-419786C13923";
createNode transform -s -n "persp";
	rename -uid "E1263623-407A-D287-52AD-38AC5A2C7DB5";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.064994486731473788 14.962308165692818 -72.111221075833868 ;
	setAttr ".r" -type "double3" -361.53835272958412 1619.7999999998344 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "4203EAA7-4B04-65CE-9161-FBBC7835DD46";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 77.686666728099169;
