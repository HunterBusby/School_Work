...
//Name: walk cycle 1.0007.ma
//Last modified: Sat, Sep 30, 2023 10:34:40 AM
//Codeset: 1252
...
fileInfo "UUID" "507BA8CF-480C-045A-EA0C-F3B9929759DD";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 9.8302256378960244 5.1286773297083315 6.5608291113093067 ;
	setAttr ".r" -type "double3" -20.738352723600041 1132.99999999958 2.642468664851704e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "45E14E17-4A2A-BB26-4D8B-B9AE84D9D9DB";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 12.733679047385401;
...
createNode animCurveTU -n "walker_rt_heel_ik_ctrl_footRoll";
	...
	setAttr -s 19 ".kit[8:18]"  18 9 9 18 18 18 18 18 
		18 18 18;
	setAttr -s 19 ".kot[8:18]"  18 5 9 18 18 5 18 18 
		18 18 18;
createNode animCurveTU -n "walker_rt_heel_ik_ctrl_footBreak";
	...
	setAttr -s 21 ".kit[0:20]"  9 9 9 9 9 9 18 9 
		18 9 18 9 9 18 18 18 18 18 18 18 18;
	setAttr -s 21 ".kot[0:20]"  9 9 9 9 9 9 18 9 
		18 9 18 5 9 18 18 5 18 18 18 18 18;
...
createNode animCurveTL -n "walker_lf_heel_ik_ctrl_translateY";
	...
	setAttr -s 16 ".ktv[0:15]"  1 0.01384857339934753 4 0.01384857339934753
		 ...
		 19 -0.033 22 -0.033 25 0.014 26 0 35 -0.022 51 0 75 0 78 0.64211089344191363 84 0.64211089344191363;
	setAttr -s 16 ".kit[2:15]"  18 9 9 9 9 9 9 9 
		9 18 18 18 18 18;
	setAttr -s 16 ".kot[2:15]"  18 9 9 9 9 9 9 5 
		9 18 18 18 18 18;
createNode animCurveTL -n "walker_lf_heel_ik_ctrl_translateZ";
	...
	setAttr -s 16 ".ktv[0:15]"  1 -1.0483909399442253 4 -1.1822588747797187
		 ...
		 19 -0.203 22 -0.606 25 -1.048 26 0 35 -0.156 51 0 75 0 78 -1.1699409983977256 84 0.70063423478895648;
	setAttr -s 16 ".kit[2:15]"  18 9 9 9 9 9 9 9 
		9 18 18 18 18 18;
	setAttr -s 16 ".kot[2:15]"  18 9 9 9 9 9 9 5 
		9 18 18 18 18 18;
...
createNode animCurveTU -n "walker_lf_heel_ik_ctrl_footRoll";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 15 ".ktv[0:14]"  1 30.800000000000004 4 51.800000000000004
		 7 51.800000000000004 10 -5.6 13 -22.1 16 0 19 0 22 23.9 25 30.8 26 0 35 27 51 0 75 0
		 78 0 84 0;
...
createNode animCurveTU -n "walker_lf_heel_ik_ctrl_footBreak";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 16 ".ktv[0:15]"  1 55 4 55 5 0 6 -11.8 7 0 10 0 13 0 16 0
		 19 55 22 55 25 55 26 0 51 0 75 0 78 0 84 0;
	setAttr -s 16 ".kit[2:15]"  18 18 9 9 9 9 9 9 
		9 9 18 18 18 18;
	setAttr -s 16 ".kot[2:15]"  18 18 9 9 9 9 9 9 
		5 9 18 18 18 18;
