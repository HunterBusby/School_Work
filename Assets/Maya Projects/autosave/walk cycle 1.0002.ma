...
//Name: walk cycle 1.0002.ma
//Last modified: Fri, Sep 29, 2023 12:49:24 PM
//Codeset: 1252
...
fileInfo "UUID" "99DE4E6C-43FD-A37C-C79E-0987F133D550";
...
createNode animCurveTL -n "CTRL_Main_translateY";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 17 ".ktv[0:16]"  1 -0.13441104219708588 4 -0.25042991905451384
		 ...
		 39 0.44339305174790988 50 0 51 0 53 -0.20691675748235827;
...
createNode animCurveTU -n "walker_rt_heel_ik_ctrl_footRoll";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 15 ".ktv[0:14]"  1 -22.1 4 0 7 0 10 23.900000000000002 13 30.8
		 16 51.8 19 51.8 22 -5.6 23 -14.129629629629834 25 -22.1 26 0 35 27 39 52.1 50 0 51 0;
	setAttr -s 15 ".kit[8:14]"  18 9 18 18 18 18 18;
	setAttr -s 15 ".kot[8:14]"  18 9 18 18 18 18 18;
createNode animCurveTU -n "walker_rt_heel_ik_ctrl_footBreak";
	rename -uid "18B282E0-47D5-2747-2F0E-93AB47478A34";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 17 ".ktv[0:16]"  1 55 4 55 7 55 10 55 13 55 16 55 17 0 19 0
		 20 -18.1 22 0 23 1.6088888888889041 25 0 26 0 35 55 39 20 50 0 51 0;
	setAttr -s 17 ".kit[6:16]"  18 9 18 9 18 9 18 18 
		18 18 18;
	setAttr -s 17 ".kot[6:16]"  18 9 18 9 18 9 18 18 
		18 18 18;
createNode animCurveTL -n "walker_rt_heel_ik_ctrl_translateY";
	rename -uid "73F84650-4604-19A4-ACE8-7DADE9EE1128";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 15 ".ktv[0:14]"  1 -0.032844329404068111 4 -0.032844329404068111
		 ...
		 51 0;
	setAttr -s 15 ".kit[6:14]"  18 9 18 9 18 9 18 18 
		18;
	setAttr -s 15 ".kot[6:14]"  18 9 18 9 18 9 18 18 
		18;
createNode animCurveTL -n "walker_rt_heel_ik_ctrl_translateZ";
	rename -uid "382DB072-4054-C6D7-19EF-C0BE0DC2FF33";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 15 ".ktv[0:14]"  1 0.93162235471218269 4 0.61918437823016181
...
createNode animCurveTL -n "CTRL_Main_translateZ";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 16 ".ktv[0:15]"  1 0 4 -0.17789193708877143 7 0 10 0.077341376934980999
		 13 0 16 -0.178 19 0 22 0.077 25 0 26 0 29 -0.20691675748235738 32 -0.38427397818152098
		 36 -0.51729189370589324 39 -0.51729189370589324 50 0 51 0;
...
createNode animCurveTL -n "walker_lf_heel_ik_ctrl_translateX";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 12 ".ktv[0:11]"  1 0 4 0 7 0 10 0 13 0 16 -1.4411479270790191e-17
		 19 0 22 0 25 0 26 0 50 0 51 0;
	setAttr -s 12 ".kit[9:11]"  18 18 18;
	setAttr -s 12 ".kot[9:11]"  18 18 18;
createNode animCurveTL -n "walker_lf_heel_ik_ctrl_translateY";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 13 ".ktv[0:12]"  1 0.01384857339934753 4 0.01384857339934753
		 5 -0.12826695488449441 7 0.42437690689486068 10 0.56052138375433547 13 -0.033 16 -0.033
		 19 -0.033 22 -0.033 25 0.014 26 0 50 0 51 0;
	setAttr -s 13 ".kit[2:12]"  18 9 9 9 9 9 9 9 
		18 18 18;
	setAttr -s 13 ".kot[2:12]"  18 9 9 9 9 9 9 9 
		18 18 18;
createNode animCurveTL -n "walker_lf_heel_ik_ctrl_translateZ";
	rename -uid "E4001EFD-400A-2C59-7AEA-66BA9EE83B26";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 13 ".ktv[0:12]"  1 -1.0483909399442253 4 -1.1822588747797187
		 5 -1.3924710652937988 7 -0.67356072240484344 10 1.1035140832048467 13 0.932 16 0.66232134129755604
		 19 -0.203 22 -0.606 25 -1.048 26 0 50 0 51 0;
	setAttr -s 13 ".kit[2:12]"  18 9 9 9 9 9 9 9 
		18 18 18;
	setAttr -s 13 ".kot[2:12]"  18 9 9 9 9 9 9 9 
		18 18 18;
...
createNode animCurveTL -n "walker_rt_heel_ik_ctrl_translateX";
	...
	setAttr -s 13 ".ktv[0:12]"  1 0 4 -1.307049462830552e-16 7 -7.5901357066490771e-17
		 ...
		 50 0 51 0;
	setAttr -s 13 ".kit[8:12]"  18 9 18 18 18;
	setAttr -s 13 ".kot[8:12]"  18 9 18 18 18;
...
createNode animCurveTU -n "walker_rt_heel_ik_ctrl_pvControl";
	...
	setAttr -s 13 ".ktv[0:12]"  1 1 4 1 7 1 10 1 13 1 16 1 19 1 22 1 23 1
		 25 1 26 1 50 1 51 1;
	setAttr -s 13 ".kot[8:12]"  5 9 5 5 5;
...
createNode animCurveTU -n "walker_lf_heel_ik_ctrl_pvControl";
	...
	setAttr -s 12 ".ktv[0:11]"  1 1 4 1 7 1 10 1 13 1 16 1 19 1 22 1 25 1
		 26 1 50 1 51 1;
	setAttr -s 12 ".kot[9:11]"  5 5 5;
createNode animCurveTU -n "walker_lf_heel_ik_ctrl_footRoll";
	rename -uid "05212895-441D-C69F-6A8A-22B2467A03AD";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 13 ".ktv[0:12]"  1 30.800000000000004 4 51.800000000000004
...
createNode animCurveTU -n "walker_lf_heel_ik_ctrl_footBreak";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 15 ".ktv[0:14]"  1 55 4 55 5 0 6 -11.8 7 0 10 0 13 0 16 0
		 19 55 22 55 25 55 26 55 35 55 50 0 51 0;
	setAttr -s 15 ".kit[2:14]"  18 18 9 9 9 9 9 9 
		9 18 18 18 18;
	setAttr -s 15 ".kot[2:14]"  18 18 9 9 9 9 9 9 
		9 18 18 18 18;
...
createNode animCurveTA -n "CTRL_Main_rotateZ";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 13 ".ktv[0:12]"  1 0 3 0 4 0 7 0 10 0 13 0 16 0 19 0 22 0
		 25 0 26 0 50 0 51 0;
	setAttr -s 13 ".kit[2:12]"  18 9 9 9 9 9 9 9 
		18 18 18;
	setAttr -s 13 ".kot[2:12]"  18 9 9 9 9 9 9 9 
