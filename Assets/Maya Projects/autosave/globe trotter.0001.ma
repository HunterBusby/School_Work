...
//Name: globe trotter.0001.ma
//Last modified: Fri, Oct 13, 2023 08:03:44 PM
//Codeset: 1252
...
fileInfo "UUID" "7BABD516-43F5-2F06-5AD4-22A68B941E02";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -36.240397205171305 34.647602711907496 -20.016844898947138 ;
	setAttr ".r" -type "double3" -44.138352710769901 2035.4000000007404 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "45E14E17-4A2A-BB26-4D8B-B9AE84D9D9DB";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 57.996909444005944;
