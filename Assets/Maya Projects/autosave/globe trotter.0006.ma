...
//Name: globe trotter.0006.ma
//Last modified: Fri, Oct 13, 2023 09:09:58 PM
//Codeset: 1252
...
fileInfo "UUID" "255688B2-458B-73DD-545C-E3BE683A1530";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -13.0578860883146 0.92206198552377117 -33.377154246386475 ;
	setAttr ".r" -type "double3" 1.3673955384739593 4514.2985402212407 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 33.484181724940058;
...
createNode transform -n "tube_object1" -p "|Globe_Core|hunte__dev__Tree_subnet__1_01";
...
createNode mesh -n "lineartaper2_0Shape" -p "|Globe_Core|hunte__dev__Tree_subnet__1_01|tube_object1|lineartaper2_0";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
createNode transform -n "lineartaper2_0" -p "Globe_Core";
	rename -uid "4BE98D13-4C78-A2EA-9FDA-968B257F37EA";
	setAttr ".t" -type "double3" 0 1.0007328950678349 0 ;
	setAttr ".s" -type "double3" 0.042426509627468308 0.042426509627468308 0.042426509627468308 ;
	setAttr ".rp" -type "double3" -0.33861707763542753 0.019004540496304952 -0.2464125647226679 ;
	setAttr ".sp" -type "double3" -7.9812617301940918 0.44794023036956787 -5.807985782623291 ;
	setAttr ".spt" -type "double3" 7.6426446525586647 -0.42893568987326292 5.561573217900623 ;
createNode mesh -n "lineartaper2_0Shape" -p "|Globe_Core|lineartaper2_0";
...
connectAttr "group2.mwc" "|Globe_Core|hunte__dev__Tree_subnet__1_02|tube_object1|lineartaper2_0|lineartaper2_0Shape.iog.og[1].gco"
		;
connectAttr ":time1.o" "|Globe_Core|hunte__dev__Tree_subnet__1_01.inTime";
connectAttr "|Globe_Core|hunte__dev__Tree_subnet__1_01.outputObjects[0].outputObjectTranslate" "|Globe_Core|hunte__dev__Tree_subnet__1_01|tube_object1.t"
		;
connectAttr "|Globe_Core|hunte__dev__Tree_subnet__1_01.outputObjects[0].outputObjectRotate" "|Globe_Core|hunte__dev__Tree_subnet__1_01|tube_object1.r"
		;
connectAttr "|Globe_Core|hunte__dev__Tree_subnet__1_01.outputObjects[0].outputObjectScale" "|Globe_Core|hunte__dev__Tree_subnet__1_01|tube_object1.s"
		;
...
connectAttr "group2.mwc" "|Globe_Core|hunte__dev__Tree_subnet__1_01|tube_object1|lineartaper2_0|lineartaper2_0Shape.iog.og[1].gco"
		;
connectAttr "transformGeometry7.og" "|Globe_Core|lineartaper2_0|lineartaper2_0Shape.i"
		;
connectAttr "groupId11.id" "|Globe_Core|lineartaper2_0|lineartaper2_0Shape.iog.og[0].gid"
		;
connectAttr "group1.mwc" "|Globe_Core|lineartaper2_0|lineartaper2_0Shape.iog.og[0].gco"
		;
connectAttr "groupId12.id" "|Globe_Core|lineartaper2_0|lineartaper2_0Shape.iog.og[1].gid"
		;
connectAttr "group2.mwc" "|Globe_Core|lineartaper2_0|lineartaper2_0Shape.iog.og[1].gco"
		;
...
connectAttr "|Globe_Core|hunte__dev__Tree_subnet__1_05|tube_object1|lineartaper2_0|lineartaper2_0Shape.iog.og[0]" "group1.dsm"
		 -na;
connectAttr "|Globe_Core|lineartaper2_0|lineartaper2_0Shape.iog.og[0]" "group1.dsm"
		 -na;
connectAttr "|Globe_Core|hunte__dev__Tree_subnet__1_01.outputObjects[0].outputGeos[0].outputParts[0].outputPartMeshData" "groupParts1.ig"
		;
...
connectAttr "|Globe_Core|hunte__dev__Tree_subnet__1_05|tube_object1|lineartaper2_0|lineartaper2_0Shape.iog.og[1]" "group2.dsm"
		 -na;
connectAttr "|Globe_Core|lineartaper2_0|lineartaper2_0Shape.iog.og[1]" "group2.dsm"
		 -na;
...
connectAttr "|hunte__dev__Tree_subnet__1_01.outputObjects[0].outputGeos[0].outputParts[0].outputPartMeshData" "groupParts11.ig"
		;
...
connectAttr "|Globe_Core|hunte__dev__Tree_subnet__1_05|tube_object1|lineartaper2_0|lineartaper2_0Shape.iog" ":initialShadingGroup.dsm"
		 -na;
connectAttr "|Globe_Core|lineartaper2_0|lineartaper2_0Shape.iog" ":initialShadingGroup.dsm"
		 -na;
// End of globe trotter.0006.ma
