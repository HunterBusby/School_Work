...
//Name: walk cycle 1.0001.ma
//Last modified: Fri, Sep 29, 2023 12:38:10 PM
//Codeset: 1252
...
fileInfo "UUID" "009D85D8-4C35-93E1-FADC-87AC8042BAE2";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 9.664408849212526 6.3570690878711344 9.037714139554355 ;
	setAttr ".r" -type "double3" -18.938352722821406 763.39999999991687 -2.1887321486233071e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "45E14E17-4A2A-BB26-4D8B-B9AE84D9D9DB";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 15.274830435148733;
...
createNode animCurveTL -n "CTRL_Main_translateY";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 14 ".ktv[0:13]"  1 -0.13441104219708588 4 -0.25042991905451384
...
createNode animCurveTU -n "walker_rt_heel_ik_ctrl_footRoll";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 13 ".ktv[0:12]"  1 -22.1 4 0 7 0 10 23.900000000000002 13 30.8
		 16 51.8 19 51.8 22 -5.6 23 -14.129629629629834 25 -22.1 26 0 35 27 39 52.1;
...
createNode animCurveTU -n "walker_rt_heel_ik_ctrl_footBreak";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 15 ".ktv[0:14]"  1 55 4 55 7 55 10 55 13 55 16 55 17 0 19 0
		 20 -18.1 22 0 23 1.6088888888889041 25 0 26 0 35 55 39 20;
...
createNode animCurveTL -n "walker_rt_heel_ik_ctrl_translateY";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 13 ".ktv[0:12]"  1 -0.032844329404068111 4 -0.032844329404068111
		 7 -0.032844329404068111 10 -0.032844329404068111 13 0.014 16 0.014 17 0.044866278916252972
		 19 0.424 20 0.34651464858356495 22 0.561 23 0.41726536457034968 25 -0.033 26 0;
	setAttr -s 13 ".kit[6:12]"  18 9 18 9 18 9 18;
	setAttr -s 13 ".kot[6:12]"  18 9 18 9 18 9 18;
createNode animCurveTL -n "walker_rt_heel_ik_ctrl_translateZ";
	rename -uid "382DB072-4054-C6D7-19EF-C0BE0DC2FF33";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 13 ".ktv[0:12]"  1 0.93162235471218269 4 0.61918437823016181
...
createNode animCurveTL -n "CTRL_Main_translateZ";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 14 ".ktv[0:13]"  1 0 4 -0.17789193708877143 7 0 10 0.077341376934980999
		 13 0 16 -0.178 19 0 22 0.077 25 0 26 0 29 -0.20691675748235738 32 -0.38427397818152098
		 36 -0.51729189370589324 39 -0.51729189370589324;
	setAttr -s 14 ".kit[9:13]"  18 18 18 18 18;
	setAttr -s 14 ".kot[9:13]"  18 18 18 18 18;
...
createNode animCurveTL -n "walker_lf_heel_ik_ctrl_translateY";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 11 ".ktv[0:10]"  1 0.01384857339934753 4 0.01384857339934753
		 5 -0.12826695488449441 7 0.42437690689486068 10 0.56052138375433547 13 -0.033 16 -0.033
		 19 -0.033 22 -0.033 25 0.014 26 0;
	setAttr -s 11 ".kit[2:10]"  18 9 9 9 9 9 9 9 
		18;
	setAttr -s 11 ".kot[2:10]"  18 9 9 9 9 9 9 9 
		18;
createNode animCurveTL -n "walker_lf_heel_ik_ctrl_translateZ";
	rename -uid "E4001EFD-400A-2C59-7AEA-66BA9EE83B26";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 11 ".ktv[0:10]"  1 -1.0483909399442253 4 -1.1822588747797187
		 5 -1.3924710652937988 7 -0.67356072240484344 10 1.1035140832048467 13 0.932 16 0.66232134129755604
		 19 -0.203 22 -0.606 25 -1.048 26 0;
	setAttr -s 11 ".kit[2:10]"  18 9 9 9 9 9 9 9 
		18;
	setAttr -s 11 ".kot[2:10]"  18 9 9 9 9 9 9 9 
		18;
...
createNode animCurveTL -n "walker_rt_heel_ik_ctrl_translateX";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 11 ".ktv[0:10]"  1 0 4 -1.307049462830552e-16 7 -7.5901357066490771e-17
		 10 0 13 0 16 0 19 0 22 1.751210174063348e-17 23 1.2989572881585577e-16 25 0 26 0;
	setAttr -s 11 ".kit[8:10]"  18 9 18;
	setAttr -s 11 ".kot[8:10]"  18 9 18;
...
createNode animCurveTA -n "walker_rt_heel_ik_ctrl_rotateX";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 11 ".ktv[0:10]"  1 0 4 0 7 0 10 0 13 0 16 0 19 0 22 0 23 0
		 25 0 26 0;
	setAttr -s 11 ".kit[8:10]"  18 9 18;
	setAttr -s 11 ".kot[8:10]"  18 9 18;
...
createNode animCurveTU -n "walker_rt_heel_ik_ctrl_pvControl";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 11 ".ktv[0:10]"  1 1 4 1 7 1 10 1 13 1 16 1 19 1 22 1 23 1
		 25 1 26 1;
	setAttr -s 11 ".kot[8:10]"  5 9 5;
...
createNode animCurveTU -n "walker_lf_heel_ik_ctrl_footRoll";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 11 ".ktv[0:10]"  1 30.800000000000004 4 51.800000000000004
		 7 51.800000000000004 10 -5.6 13 -22.1 16 0 19 0 22 23.9 25 30.8 26 0 35 27;
...
createNode animCurveTU -n "walker_lf_heel_ik_ctrl_footBreak";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 13 ".ktv[0:12]"  1 55 4 55 5 0 6 -11.8 7 0 10 0 13 0 16 0
		 19 55 22 55 25 55 26 55 35 55;
	setAttr -s 13 ".kit[2:12]"  18 18 9 9 9 9 9 9 
		9 18 18;
	setAttr -s 13 ".kot[2:12]"  18 18 9 9 9 9 9 9 
		9 18 18;
...
createNode animCurveTA -n "CTRL_Main_rotateZ";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 11 ".ktv[0:10]"  1 0 3 0 4 0 7 0 10 0 13 0 16 0 19 0 22 0
		 25 0 26 0;
	setAttr -s 11 ".kit[2:10]"  18 9 9 9 9 9 9 9 
		18;
	setAttr -s 11 ".kot[2:10]"  18 9 9 9 9 9 9 9 
