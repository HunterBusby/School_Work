...
//Name: Robot Movement.0029.ma
//Last modified: Thu, Oct 19, 2023 02:29:05 PM
//Codeset: 1252
...
fileInfo "UUID" "B09DA389-494A-B50F-FA2E-83A014A56E27";
...
createNode animCurveTL -n "PALbot_cog_ctrl_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 10 ".ktv[0:9]"  0 -0.58390107807885627 4 -1.3246494729133165
		 8 -0.5316677212503258 12 -0.52473927154743194 16 -0.361335627300166 20 -0.84727533187298398
		 24 -1.325 28 -1.1729191081357553 32 -1.0097189238121942 36 -0.361;
...
createNode animCurveTA -n "PALbot_cog_ctrl_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  0 0 4 7.5454158175126125 8 0 12 0 16 0 20 0
		 24 0 28 0 32 0;
	setAttr -s 9 ".kit[0:8]"  9 9 9 9 18 18 18 18 
		18;
	setAttr -s 9 ".kot[0:8]"  9 9 9 9 18 18 18 18 
...
createNode animCurveTL -n "PALbot_L_IK_Foot_ctrl_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 10 ".ktv[0:9]"  0 0.21109723893529786 4 0.036986049506870788
...
createNode animCurveTL -n "PALbot_L_IK_Foot_ctrl_translateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 10 ".ktv[0:9]"  0 3.6305950262677182 4 1.6631385857264891
...
createNode animCurveTA -n "PALbot_L_IK_Foot_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 10 ".ktv[0:9]"  0 -27.024056918987924 4 -0.14466932926678092
...
createNode reference -n "PALBotRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"translate" " -type \"double3\" -0.45017259147914213 0.27638288008221856 -3.23274005604418013"
		...
		"rotate" " -type \"double3\" -5.9292609389739912 0 0"
		2 "|PALBot:PALBOT_GRP|PALBot:PALbot_LOC|PALBot:PALbot_CTRLs|PALBot:PALbot_MAIN|PALBot:PALbot_root|PALBot:PALbot_R_IK_Foot_offset|PALBot:PALbot_R_IK_Foot_ctrl|PALBot:PALbot_R_IK_heel_lift_offset|PALBot:PALbot_R_IK_heel_lift_tip|PALBot:PALbot_R_IK_foot_tip_offset|PALBot:PALbot_R_IK_foot_tip|PALBot:PALbot_R_IK_footBall_offset|PALBot:PALbot_R_IK_footBall_ctrl" 
		"rotateX" " -av"
