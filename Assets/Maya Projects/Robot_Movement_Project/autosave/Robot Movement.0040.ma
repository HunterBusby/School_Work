...
//Name: Robot Movement.0040.ma
//Last modified: Fri, Oct 20, 2023 02:50:23 PM
//Codeset: 1252
...
fileInfo "UUID" "7CCD6335-4F51-5D71-29ED-FD8D193B66E5";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 39.777534838481024 27.85071015554395 10.004625248453864 ;
	setAttr ".r" -type "double3" -24.041132384506138 1872.7542347465549 -5.3640234729320817e-15 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 41.246475635320387;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "BD9402F7-4BE5-22C4-C7C0-F3A90B0B182D";
	setAttr -s 17 ".lnk";
	setAttr -s 17 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "26A9A333-4DF6-A699-2B84-0991F90CB28F";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 1 0 ;
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "B3731732-4267-727A-F4F4-7290D8003AFB";
createNode displayLayerManager -n "layerManager";
	rename -uid "B5F64B3C-4970-6014-96E7-7F8151D609D7";
createNode displayLayer -n "defaultLayer";
	rename -uid "2D41B0FD-439A-68BB-AED7-E9AEA5D7F9EF";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "4602CE4B-4169-845C-03EC-4BA9568E7071";
...
createNode animCurveTA -n "PALbot_L_Arm_ctrl_rotateY1";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 0 4 0 24 45.998 28 21.45643108306766;
...
createNode animCurveTA -n "PALbot_L_Arm_ctrl_rotateZ1";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  0 0 4 4.5261320624496522 12 -9.4821048158904837
		 16 -40.97543174462394 20 -15.393000000000002 24 -32.184 28 -32.183999999999976;
	setAttr -s 7 ".kit[0:6]"  9 9 9 18 18 18 18;
	setAttr -s 7 ".kot[0:6]"  9 9 9 18 18 18 18;
createNode animCurveTL -n "PALbot_L_Arm_ctrl_translateX1";
	rename -uid "B1CE4CB4-4DF8-99CA-7C59-FE8EFA873803";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  0 0 4 0 12 0 16 0 20 0 24 0 28 0;
	setAttr -s 7 ".kit[0:6]"  9 9 9 18 18 18 18;
	setAttr -s 7 ".kot[0:6]"  9 9 9 18 18 18 18;
...
createNode animCurveTA -n "PALbot_L_FK_Elbow_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 11 ".ktv[0:10]"  0 -28.241403907486951 4 -7.9412481040709482
		 8 11.340675214511593 12 5.079035233551501 17 5.1145362138504833 21 -34.641536556693474
		 24 -70.07 28 -88.859181391871971 32 -95.766335877086917 36 -44.168978149138432 40 -28.241;
	setAttr -s 11 ".kit[0:10]"  9 9 9 9 18 18 18 18 
		18 18 18;
	setAttr -s 11 ".kot[0:10]"  9 9 9 9 18 18 18 18 
		18 18 18;
createNode animCurveTL -n "PALbot_L_FK_Elbow_ctrl_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 11 ".ktv[0:10]"  0 0 4 0 8 0 12 0 17 0 21 0 24 0 28 0 32 0
		 36 0 40 0;
	setAttr -s 11 ".kit[0:10]"  9 9 9 9 18 18 18 18 
		18 18 18;
	setAttr -s 11 ".kot[0:10]"  9 9 9 9 18 18 18 18 
