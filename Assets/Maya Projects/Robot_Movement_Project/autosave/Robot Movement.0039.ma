...
//Name: Robot Movement.0039.ma
//Last modified: Fri, Oct 20, 2023 02:34:20 PM
//Codeset: 1252
...
fileInfo "UUID" "67C19BCA-4BA3-AE75-70E2-D0BA2A7F8746";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -10.035285933628838 28.186439535647999 27.416445412474271 ;
	setAttr ".r" -type "double3" -33.041132383259274 1414.3542347467189 0 ;
...
createNode animCurveTA -n "PALbot_L_ShoulderRotate_ctrl_rotateZ";
	...
	setAttr -s 6 ".ktv[0:5]"  0 -53.719723097353722 4 -64.481282300233914
		 8 -29.252339271518718 12 1.129082832864581 20 82.654570963909691 24 94;
...
createNode animCurveTA -n "PALbot_L_Arm_ctrl_rotateY1";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 0 4 0 12 0 16 0 20 0;
...
createNode animCurveTA -n "PALbot_L_Arm_ctrl_rotateZ1";
	...
	setAttr -s 5 ".ktv[0:4]"  0 0 4 4.5261320624496522 12 -9.4821048158904837
		 16 -40.97543174462394 20 -15.393000000000002;
	setAttr -s 5 ".kit[3:4]"  18 18;
	setAttr -s 5 ".kot[3:4]"  18 18;
...
createNode animCurveTA -n "PALbot_L_FK_Elbow_ctrl_rotateX";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  0 -28.241403907486951 4 -7.9412481040709482
		 8 11.340675214511593 12 5.079035233551501 16 -4.896923156686376 20 -29.608;
	setAttr -s 6 ".kit[4:5]"  18 18;
	setAttr -s 6 ".kot[4:5]"  18 18;
...
createNode reference -n "PALBotRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"rotateY" " -av 45.99789624773614349"
		2 "|PALBot:PALBOT_GRP|PALBot:PALbot_LOC|PALBot:PALbot_CTRLs|PALBot:PALbot_MAIN|PALBot:PALbot_root|PALBot:PALbot_cog_ctrl_offset|PALBot:PALbot_cog_ctrl|PALBot:PALbot_cog_secondary_ctrl_offset1|PALBot:PALbot_cog_secondary_ctrl|PALBot:PALbot_chestup_ctrl_offset|PALBot:PALbot_chestUp_ctrl|PALBot:PALbot_chestUp_secondary_ctrl_offset|PALBot:PALbot_chestUp_secondary_ctrl|PALBot:PALbot_R_Clavicle_offset|PALBot:PALbot_R_Clavicle_ctrl|PALBot:PALbot_R_Arm_FOLLOW|PALBot:PALbot_L_ShoulderRotate_offset|PALBot:PALbot_L_ShoulderRotate_ctrl|PALBot:PALbot_L_Arm_offset|PALBot:PALbot_L_Arm_ctrl" 
		"rotateZ" " -av -32.18374109924732807"
