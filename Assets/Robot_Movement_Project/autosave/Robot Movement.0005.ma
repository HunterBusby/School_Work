...
//Name: Robot Movement.0005.ma
//Last modified: Tue, Oct 17, 2023 04:22:24 PM
//Codeset: 1252
...
fileInfo "UUID" "E0651D53-4C75-58B7-6039-07A5F1031FFE";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 18.807686155630314 8.4257148614520769 4.0706021152193301 ;
	setAttr ".r" -type "double3" -18.938352729298245 447.39999999990624 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "3F0A55EE-4B99-C6D3-B52A-E396A2919365";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 20.261504332233184;
...
createNode transform -s -n "side";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1000.1 5.6357639805529871 -0.44932976600391283 ;
...
createNode animCurveTL -n "PALbot_cog_ctrl_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 -0.58390107807885627 4 -1.0365901705927669
...
connectAttr "PALbot_R_IK_Foot_ctrl_Heel_Peel.o" "PALBotRN.phl[16]";
connectAttr "PALbot_R_IK_Foot_ctrl_follow_hip.o" "PALBotRN.phl[17]";
connectAttr "PALbot_R_IK_Foot_ctrl_translateZ.o" "PALBotRN.phl[18]";
connectAttr "PALbot_R_IK_Foot_ctrl_translateY.o" "PALBotRN.phl[19]";
connectAttr "PALbot_R_IK_Foot_ctrl_translateX.o" "PALBotRN.phl[20]";
connectAttr "PALbot_R_IK_Foot_ctrl_rotateX.o" "PALBotRN.phl[21]";
connectAttr "PALbot_R_IK_Foot_ctrl_rotateY.o" "PALBotRN.phl[22]";
connectAttr "PALbot_R_IK_Foot_ctrl_rotateZ.o" "PALBotRN.phl[23]";
connectAttr "PALbot_R_IK_footBall_ctrl_translateX.o" "PALBotRN.phl[24]";
connectAttr "PALbot_R_IK_footBall_ctrl_translateY.o" "PALBotRN.phl[25]";
connectAttr "PALbot_R_IK_footBall_ctrl_translateZ.o" "PALBotRN.phl[26]";
connectAttr "PALbot_R_IK_footBall_ctrl_rotateX.o" "PALBotRN.phl[27]";
connectAttr "PALbot_R_IK_footBall_ctrl_rotateY.o" "PALBotRN.phl[28]";
connectAttr "PALbot_R_IK_footBall_ctrl_rotateZ.o" "PALBotRN.phl[29]";
