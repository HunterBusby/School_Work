...
//Name: Robot Movement.0045.ma
//Last modified: Fri, Oct 20, 2023 04:06:59 PM
//Codeset: 1252
...
fileInfo "UUID" "21A0E02A-48FE-8DB7-FA12-E99C1BF59C23";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -12.408907703470671 10.652465820340808 -6.2214585699708005 ;
	setAttr ".r" -type "double3" -0.041132384580453631 2071.1542347450186 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 11.540625690987307;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "6AE62BF6-457C-C7D2-713D-CA8DC7BECA79";
	setAttr -s 17 ".lnk";
	setAttr -s 17 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "19C17EE8-4AEC-3438-E54C-CE8540B1DB64";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 1 0 ;
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "41EF0CD5-49B5-4090-5574-5D871EBE5134";
createNode displayLayerManager -n "layerManager";
	rename -uid "E3F9990F-4291-E717-E467-6B9D966C6E04";
createNode displayLayer -n "defaultLayer";
	rename -uid "2D41B0FD-439A-68BB-AED7-E9AEA5D7F9EF";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "296F02CD-4DFB-D895-B9E4-5683F63A846D";
...
createNode animCurveTA -n "PALbot_R_Index01_ctrl_rotateX";
	...
	setAttr -s 11 ".ktv[0:10]"  0 61.596540497129759 4 72.907498415654786
		 8 11.6657016635808 12 4.4969482504617195 16 -3.8680984060662245 22 -15.324795784695992
		 25 -15.324795784695992 29 40.001547923741867 34 40.001547923741867 38 19.944937433420069
		 40 61.597000000000008;
...
createNode animCurveTA -n "PALbot_R_Index01_ctrl_rotateY";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 11 ".ktv[0:10]"  0 0 4 0 8 0 12 0 16 0 22 0 25 0 29 0 34 0
		 38 0 40 0;
	setAttr -s 11 ".kit[4:10]"  18 18 18 18 18 18 18;
	setAttr -s 11 ".kot[4:10]"  28 28 28 28 28 28 28;
...
createNode animCurveTA -n "PALbot_R_Index02_ctrl_rotateX";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 11 ".ktv[0:10]"  0 61.596540497129759 4 77.540731518844765
		 8 38.810871441851624 12 4.4501812776819403 16 -16.514865510988344 22 15.100612227332613
		 25 -15.371562757475781 29 39.954780950962046 34 39.954780950962046 38 19.898170460640259
		 40 61.597000000000008;
	setAttr -s 11 ".kit[4:10]"  18 18 18 18 18 18 18;
	setAttr -s 11 ".kot[4:10]"  28 28 28 28 28 28 28;
...
createNode animCurveTA -n "PALbot_R_Middle01_ctrl_rotateX";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 11 ".ktv[0:10]"  0 61.596540497129759 4 76.507498414794028
		 8 38.857638414631481 12 4.4969482504617515 16 -9.2161240065934145 22 -15.32479578469596
		 25 -15.32479578469596 29 40.001547923741924 34 40.001547923741924 38 19.944937433420101
		 40 61.597000000000008;
	setAttr -s 11 ".kit[4:10]"  18 18 18 18 18 18 18;
	setAttr -s 11 ".kot[4:10]"  28 28 28 28 28 28 28;
...
createNode animCurveTA -n "PALbot_R_Middle02_ctrl_rotateX";
	...
	setAttr -s 11 ".ktv[0:10]"  0 61.596540497129759 4 77.541372227763361
		 8 38.811512150770128 12 4.4508219866003467 16 -16.514224802069972 22 36.829077258461851
		 25 -15.370922048557381 29 39.955421659880471 34 39.955421659880471 38 19.898811169558634
		 40 61.597000000000008;
	setAttr -s 11 ".kit[4:10]"  18 18 18 18 18 18 18;
	setAttr -s 11 ".kot[4:10]"  28 28 28 28 28 28 28;
...
createNode animCurveTA -n "PALbot_R_Pinky01_ctrl_rotateX";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 11 ".ktv[0:10]"  0 61.596540497129759 4 90 8 57.577638111555061
		 12 4.4969482504616023 16 -27.62809812970362 22 21.901538554857073 25 -15.324795784696105
		 29 40.001547923741732 34 40.001547923741732 38 19.944937433419941 40 61.597000000000008;
	setAttr -s 11 ".kit[4:10]"  18 18 18 18 18 18 18;
	setAttr -s 11 ".kot[4:10]"  28 28 28 28 28 28 28;
...
createNode animCurveTA -n "PALbot_R_Pinky02_ctrl_rotateX";
	...
	setAttr ".wgt" no;
	setAttr -s 11 ".ktv[0:10]"  0 61.596540497129759 4 77.541372227763361
		 8 38.811512150770149 12 4.450821986600392 16 -16.514224802069922 22 -15.37092204855734
		 25 -15.37092204855734 29 39.955421659880528 34 39.955421659880528 38 19.898811169558716
		 40 61.597000000000008;
	setAttr -s 11 ".kit[4:10]"  18 18 18 18 18 18 18;
	setAttr -s 11 ".kot[4:10]"  28 28 28 28 28 28 28;
...
createNode animCurveTA -n "PALbot_R_Ring01_ctrl_rotateX";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 11 ".ktv[0:10]"  0 61.596540497129759 4 82.267498472312099
		 8 38.857638414631431 12 4.4969482504617533 16 -18.628099040713529 22 4.4752039573188176
		 25 -15.324795784695956 29 40.001547923741917 34 40.001547923741917 38 19.944937433420105
		 40 61.597000000000008;
	setAttr -s 11 ".kit[4:10]"  18 18 18 18 18 18 18;
	setAttr -s 11 ".kot[4:10]"  28 28 28 28 28 28 28;
createNode animCurveTA -n "PALbot_R_Ring02_ctrl_rotateX";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 11 ".ktv[0:10]"  0 61.596540497129759 4 77.540731518844709
		 8 38.810871441851525 12 4.4501812776817706 16 -16.514865510988528 22 -15.371562757475939
		 25 -15.371562757475939 29 39.954780950961926 34 39.954780950961926 38 19.898170460640138
		 40 61.597000000000008;
	setAttr -s 11 ".kit[4:10]"  18 18 18 18 18 18 18;
	setAttr -s 11 ".kot[4:10]"  28 28 28 28 28 28 28;
...
createNode animCurveTU -n "PALbot_head_ctrl_FaceLight";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  0 1 6 1 19 1 22 1 30 1 33 1 40 1;
	setAttr -s 7 ".kot[0:6]"  5 5 5 5 5 5 5;
...
createNode animCurveTL -n "PALbot_R_Pinky01_ctrl_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  8 0 16 0 22 0;
...
createNode reference -n "PALBotRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"translateZ" " -av"
		2 "|PALBot:PALBOT_GRP|PALBot:PALbot_LOC|PALBot:PALbot_CTRLs|PALBot:PALbot_MAIN|PALBot:PALbot_root|PALBot:PALbot_cog_ctrl_offset|PALBot:PALbot_R_fingers_grp|PALBot:PALbot_R_Ring01_offset|PALBot:PALbot_R_Ring01_ctrl" 
		"rotate" " -type \"double3\" -6.68005458025257948 0 0"
		2 "|PALBot:PALBOT_GRP|PALBot:PALbot_LOC|PALBot:PALbot_CTRLs|PALBot:PALbot_MAIN|PALBot:PALbot_root|PALBot:PALbot_cog_ctrl_offset|PALBot:PALbot_R_fingers_grp|PALBot:PALbot_R_Ring01_offset|PALBot:PALbot_R_Ring01_ctrl" 
		"rotateX" " -av"
		2 "|PALBot:PALBOT_GRP|PALBot:PALbot_LOC|PALBot:PALbot_CTRLs|PALBot:PALbot_MAIN|PALBot:PALbot_root|PALBot:PALbot_cog_ctrl_offset|PALBot:PALbot_R_fingers_grp|PALBot:PALbot_R_Ring01_offset|PALBot:PALbot_R_Ring01_ctrl" 
		"rotateY" " -av"
		...
		"translateZ" " -av"
		2 "|PALBot:PALBOT_GRP|PALBot:PALbot_LOC|PALBot:PALbot_CTRLs|PALBot:PALbot_MAIN|PALBot:PALbot_root|PALBot:PALbot_cog_ctrl_offset|PALBot:PALbot_R_fingers_grp|PALBot:PALbot_R_Ring01_offset|PALBot:PALbot_R_Ring01_ctrl|PALBot:PALbot_R_Ring02_offset|PALBot:PALbot_R_Ring02_ctrl" 
		"rotate" " -type \"double3\" -6.72682155303256391 0 0"
		2 "|PALBot:PALBOT_GRP|PALBot:PALbot_LOC|PALBot:PALbot_CTRLs|PALBot:PALbot_MAIN|PALBot:PALbot_root|PALBot:PALbot_cog_ctrl_offset|PALBot:PALbot_R_fingers_grp|PALBot:PALbot_R_Ring01_offset|PALBot:PALbot_R_Ring01_ctrl|PALBot:PALbot_R_Ring02_offset|PALBot:PALbot_R_Ring02_ctrl" 
		"rotateX" " -av"
		2 "|PALBot:PALBOT_GRP|PALBot:PALbot_LOC|PALBot:PALbot_CTRLs|PALBot:PALbot_MAIN|PALBot:PALbot_root|PALBot:PALbot_cog_ctrl_offset|PALBot:PALbot_R_fingers_grp|PALBot:PALbot_R_Ring01_offset|PALBot:PALbot_R_Ring01_ctrl|PALBot:PALbot_R_Ring02_offset|PALBot:PALbot_R_Ring02_ctrl" 
		"rotateY" " -av"
		...
		"translateZ" " -av"
		2 "|PALBot:PALBOT_GRP|PALBot:PALbot_LOC|PALBot:PALbot_CTRLs|PALBot:PALbot_MAIN|PALBot:PALbot_root|PALBot:PALbot_cog_ctrl_offset|PALBot:PALbot_R_fingers_grp|PALBot:PALbot_R_Pinky01_offset|PALBot:PALbot_R_Pinky01_ctrl|PALBot:PALbot_R_Pinky02_offset|PALBot:PALbot_R_Pinky02_ctrl" 
		"rotate" " -type \"double3\" -6.726180844113963 0 0"
		2 "|PALBot:PALBOT_GRP|PALBot:PALbot_LOC|PALBot:PALbot_CTRLs|PALBot:PALbot_MAIN|PALBot:PALbot_root|PALBot:PALbot_cog_ctrl_offset|PALBot:PALbot_R_fingers_grp|PALBot:PALbot_R_Pinky01_offset|PALBot:PALbot_R_Pinky01_ctrl|PALBot:PALbot_R_Pinky02_offset|PALBot:PALbot_R_Pinky02_ctrl" 
		"rotateX" " -av"
		2 "|PALBot:PALBOT_GRP|PALBot:PALbot_LOC|PALBot:PALbot_CTRLs|PALBot:PALbot_MAIN|PALBot:PALbot_root|PALBot:PALbot_cog_ctrl_offset|PALBot:PALbot_R_fingers_grp|PALBot:PALbot_R_Pinky01_offset|PALBot:PALbot_R_Pinky01_ctrl|PALBot:PALbot_R_Pinky02_offset|PALBot:PALbot_R_Pinky02_ctrl" 
		"rotateY" " -av"
